...
public class AddVideoActivity extends AppCompatActivity {
    ...
    private String [] cameraPemissions;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //camera permission
        cameraPemissions=new String[]{Manifest.permission.CAMERA,Manifest.permission.WRITE_EXTERNAL_STORAGE};
        ...
        uploadVideoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(title)){
                    ...
                    Toast.makeText(AddVideoActivity.this, "Pick a Video before upload", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (i==0){
                            ...
                            if(!checkCameraPermission()){
                                ...
                                // if permision allowed , take picture
                                videoPickCamera();
                            }
                        }
                        else if(i==1){
    ...
    private void requestCameraPermission(){
        ...
        ActivityCompat.requestPermissions(this,cameraPemissions, CAMERA_REQUEST_CODE);
    }
            ...
            case CAMERA_REQUEST_CODE:
                if(grantResults.length>0){
                    ...
                    if (cameraAccepted && storageAccepted){
                        ...
                        Toast.makeText(this, "Cmaer & Storage Permission required", Toast.LENGTH_SHORT).show();
                    }
    ...
    public boolean onSupportNavigateUp() {
        onBackPressed(); // go to previous activity on clicking back button
